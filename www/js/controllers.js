angular
  ...
  .controller ('menuCtrl', function (
    ...
    var link = 'http://myblabber.com/staging-v2/api/get-businesses';
    $http
  ...
  .controller ('loginCtrl', function (
    ...
    $scope.login = function () {
      str =
        'http://localhost:8100/#SERVER_SIDE/user-details.php?e=' +
        $scope.user.email +
        '&p=' +
        $scope.user.password;
      $http
  ...
  .controller ('productPageCtrl', function ($scope) {
    ...
    angular.element (document).ready (function () {
      ...
      $scope.img =
        'img/' + sessionStorage.getItem ('product_info_img') + '.jpg';
